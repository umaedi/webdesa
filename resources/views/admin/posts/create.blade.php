              ...
              <div class="card-body">
                <form action="/admin/posts" method="POST" novalidate enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input  id="title" type="text" class="form-control @error('judul') is-invalid @enderror" name="judul">
                    </div>
                    <div class="form-group mb-3">
                        <label for="">Slug</label>
                        <input  id="slug" name="slug" type="text" readonly autocomplete="slug" class="form-control @error('slug') is-invalid @enderror">
                    </div>
                    <div class="form-group mb-3">
                        <label for="">Deskripsi</label>
                        <textarea  id="description" name="deskripsi" type="text"  class="form-control @error('deskripsi') is-invalid @enderror"></textarea>
                    </div>
