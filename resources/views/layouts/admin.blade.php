        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="{{ Request::is('admin/dashboard') ? 'active' : '' }}">
              <a href="/admin/dashboard" class="nav-link "><i class="fa fa-home"></i><span>Dashboard</span></a>
            </li>
            <li class="{{ Request::is('admin/suket*') ? 'active' : '' }}">
              <a href="{{ route('admin.suket') }}" class="nav-link "><i class="fa fa-folder"></i><span>Pengajuan Surat</span></a>
            </li>
            <li class="{{ Request::is('admin/pengaduan*') ? 'active' : '' }}">
              <a href="{{ route('admin.pengaduan') }}" class="nav-link "><i class="fa fa-headset"></i><span>Pengaduan</span></a>
            </li>
            <li class="{{ Request::is('admin/kritik*') ? 'active' : '' }}">
              <a href="{{ route('admin.kritik') }}" class="nav-link "><i class="fa fa-comment"></i><span>Kritik & Saran</span></a>
            </li>
            <li class="{{ Request::is('admin/posts*') ? 'active' : '' }}">
              <a href="/admin/posts" class="nav-link "><i class="fa fa-newspaper"></i><span>Informasi</span></a>
            </li>
